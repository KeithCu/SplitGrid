...
"""Verification and contract tests for split-grid serialization.

Default pytest runs deal contracts + hypothesis round-trips. CrossHair
subprocess checks are marked ``slow``.
"""
...
from tests.serialization_ab_support import flatten_semantic_cells
...
CROSSHAIR_MODULE = "src/splitgrid/codec.py"
...
_CROSSHAIR_FQN_TARGETS = (
    "splitgrid.codec.is_split_grid",
    "splitgrid.codec.is_multi_data",
    "splitgrid.codec.host_pack_multi_data",
)
