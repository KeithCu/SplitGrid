#!/usr/bin/env python3
# SplitGrid - benchmark different split_grid unpacking strategies (child / NumPy).
# Run from the repo root: python scripts/bench_unpacking_opt.py
"""Compare list-loop unpacking against NumPy vectorized masking."""
